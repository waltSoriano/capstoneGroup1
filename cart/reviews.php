...
<!-- Testimonials -->
<div class="testimonial" style="margin-bottom: 110px">
    <br>
    <br>
    <br>
    <br>
        ...
        <div class="row">
            <div class="col-3">
                ...
                <div class="rating">
                    ...
                    <img src="photos/image1.JPG" alt="This is a photo of a person.">
                    <h3>Walt </h3>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="rating">
                    ...
                    <i class="fa fa-star-half-o"></i>
                    <i class="fa fa-star-o" aria-hidden="true"></i>
                    <img src="photos/image2.JPG" alt="This is a photo of a person.">
                    <h3>Kristine</h3>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="rating">
                    ...
                    <i class="fa fa-star-half-o"></i>
                    <i class="fa fa-star-o" aria-hidden="true"></i>
                    <img src="photos/image3.JPG" alt="This is a photo of a person.">
                    <h3>Rusell</h3>
                </div>
            </div>
        </div>
